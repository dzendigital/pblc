...
class ReportController extends Controller
{
    ...
    {   
        $response = array(
            "item" => $this->itemRepository->report()
        );
        switch ($request->input('order')) {
            case 'a-z':
                $response = array(
                    "item" => $this->itemRepository->reportOrderBy("title", "asc")
                );
            break;
            case 'z-a':
                $response = array(
                    "item" => $this->itemRepository->reportOrderBy("title", "desc")
                );
            break;
        }
        return view( "client/account/report/index", $response);
    }
