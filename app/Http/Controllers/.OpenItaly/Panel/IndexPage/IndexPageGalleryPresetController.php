...
use App\Http\Controllers\Panel\IndexPage\IndexPagePresetController;
use Illuminate\Http\Request;

# работа с файлами
use Illuminate\Support\Facades\Storage;

class IndexPageGalleryPresetController extends IndexPagePresetController
{
    /**
     * 
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->file('file') as $file) {
            $url = Storage::put("public/tmp/index-page/presets/gallery", $file); 
