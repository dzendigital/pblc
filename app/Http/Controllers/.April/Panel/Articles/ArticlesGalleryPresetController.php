...
use App\Http\Controllers\Panel\Articles\ArticlesPresetController;
use Illuminate\Http\Request;

# работа с файлами
use Illuminate\Support\Facades\Storage;

class ArticlesGalleryPresetController extends ArticlesPresetController
{
    /**
     * 
     * Сохраняет пресет в рамках описаного шаблона
     *
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->file('file') as $file) {
            $url = Storage::put("public/tmp/catalog/articles/presets/gallery", $file); 
