...
namespace App\Http\Controllers\Panel\Articles;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

use App\Models\Catalog\Articles;
use App\Models\Catalog\Gallery;
use App\Models\Catalog\Theme;
use App\Models\Catalog\Presets;

use App\Http\Requests\Panel\Catalog\ArticlesRequest;
...
class ArticlesController extends Controller
{
    ...
    {
        // dd(__METHOD__,  Articles::latest()->with(['theme', 'gallery', 'presets'])->get());
        return view( config('app.project') . ".panel/articles/index", [
            'items' => Articles::latest()->with(['theme', 'gallery', 'presets'])->get(),
        ]);
    }
